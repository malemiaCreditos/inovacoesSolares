...
export function LensDemo({ id }: any) {
  ...
  return (
    <div>
      <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#35301d] to-[#e4bf08] p-8 my-10">
        <Rays />
        <Beams />
